...
<body>
    ...
    <section class="books-section">
        ...
        <!-- SEARCH & FILTER -->
        <form method="GET" action="dashboard.php" style="margin-bottom: 30px; display: flex; justify-content: center; gap: 10px;">
            ...
            <?php if (!empty($_GET['q']) || !empty($_GET['category'])): ?>
                <a href="dashboard.php" class="btn" style="margin-top:0; background: #e74c3c;">Reset</a>
            <?php endif; ?>
        </form>
        ...
        <div class="book-container">
            ...
            <?php else: ?>
                <?php foreach ($filteredBooks as $book): ?>
                    <div class="book-card">
                        <img src="<?= htmlspecialchars($book['cover'] && strpos($book['cover'], 'http') === 0 ? $book['cover'] : 'https://via.placeholder.com/200x300') ?>" alt="<?= htmlspecialchars($book['title']) ?>">
